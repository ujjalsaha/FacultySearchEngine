...
class ElasticSearchAPI:
    ...
    def add_records(self, corpus: dict):
        ...
        try:
            ...
            print ("Unexpected Exception occured: ", repr(e))
...
# fuzzy search
# print("fuzzy search")
# es.search(index="faculty_index", doc_type='faculty', query={"query": {"fuzzy": {'summary':'technology'}}})
