...
if __name__ == '__main__':
    ...
    doc = "IN THIS SECTION Research and Faculty Faculty Directory Faculty Directory Faculty Fellows Faculty Directory Marcelo Worsley Assistant Professor of Computer Science Assistant Professor of Education and Social Policy Contact 2120 Campus Drive Annenberg Room 332 Evanston, IL 60208 Email Marcelo Worsley Website Marcelo Worsley's Homepage Marcelo Worsley's Lab Departments Computer Science Education Ph.D. Learning Sciences , Stanford University, Stanford, CA M.S. Computer Science, Stanford University, Stanford, CA B.S. Chemical Engineering , Stanford University, Stanford, CA B.A. Portuguese Language and Literature, Stanford University, Stanford, CA Biography Marcelo Worsley is an Assistant Professor in Computer Science and Learning Sciences. He directs the technological innovations for inclusive learning and teaching (tiilt) lab, which aims to develop pedagogical and technological solutions for supporting learning among diverse populations in hands-on, collaborative, environments. More specifically, the goal of his research is to promote equity and advance society's understanding of how students learn in complex learning environments by forging new opportunities for using multimodal technology. The use of multimodal technology is multi-fold. First, the environments that he studies allow students to experience learning across a range of modalities. Second, he uses multimodal signal processing and artificial intelligence to study how student learning is demonstrated across different modalities and time scales. Third, he designs multimodal interfaces that support inclusivity and deepen student learning, while also considering ways to use multimodal data to support student and teacher reflection. BACK TO TOP"
    doc = Document(doc,
